...
GRAPH_TYPES = ["Cycles Alive","3+ Rules Alive", "Cell Count"]
...
for GRAPH in GRAPH_TYPES:
	...
	if GRAPH == "Cycles Alive":
		...
		x = [3,4,5,6,7,8,9]
		plt.axis([1,10,-.05,1.1])
		plt.plot(x,stack["fixed-rich-source"][1:], label="source-rich", color="k", marker="s",markeredgecolor="k",ms=8,linestyle="solid", linewidth=2)
		plt.plot(x,stack["fixed-poor-source"][1:], label="souce-poor", color="k", marker="^",linestyle="solid",linewidth=2,markeredgecolor="k",ms=8)
		plt.plot(x,stack["endo-rich-source"][1:], label="stigmergy-rich", color="r", marker="s",linestyle="solid",linewidth=2,markeredgecolor="r",ms=8)
		plt.plot(x,stack["endo-poor-source"][1:], label="stigmergy-poor", color="r", marker="^",linestyle="solid",linewidth=2,markeredgecolor="r",ms=8)
		plt.plot(x,stack["fixed-rich-target"][1:], label="target-rich", color="b", marker="s",linestyle="solid",linewidth=2,markeredgecolor="b",ms=8)
		plt.plot(x,stack["fixed-poor-target"][1:], label="target-poor", color="b", marker="^",linestyle="solid",linewidth=2,markeredgecolor="b",ms=8)
	...
	plt.title("ALL Chem - Simultaneous Pass, select cell - " + GRAPH)
